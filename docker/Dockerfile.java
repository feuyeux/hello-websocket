...
# JDK (26 here) is standard Java forward compatibility (javac --release 17
...
FROM eclipse-temurin:26-jre-alpine AS server
...
FROM eclipse-temurin:26-jre-alpine AS client
RUN addgroup -S app && adduser -S -G app app
WORKDIR /app
COPY --from=build-base --chown=app:app /app/hello-ws.jar /app/
USER app
